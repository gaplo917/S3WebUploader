...
const routes: Routes = [
  ...
  { path: 'settings', component: SettingsPageComponent },
  {
    ...
    children: [
      {
        path: '**',
        component: FolderBrowserComponent,
      },
    ],
  },
  ...
  imports: [
    ...
    SimpleNotificationsModule.forRoot({
      ...
      icons: {
        ...
        success:
          '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20.7 5.3c-0.4-0.4-1-0.4-1.4 0l-10.3 10.3-4.3-4.3c-0.4-0.4-1-0.4-1.4 0s-0.4 1 0 1.4l5 5c0.2 0.2 0.4 0.3 0.7 0.3s0.5-0.1 0.7-0.3l11-11c0.4-0.4 0.4-1 0-1.4z"></path></svg>',
        // tslint:disable-next-line:max-line-length
        error:
