...
@NgModule({
  ...
  providers: [ElectronService, DomService, UpdaterService],
  declarations: [
    SpinnerComponent,
    BusyScreenComponent,
    TooltipDirective,
  ...
  exports: [SpinnerComponent, BusyScreenComponent, TooltipDirective, CheckboxComponent],
  entryComponents: [TooltipComponent, AnalyticsConsentComponent],
})
